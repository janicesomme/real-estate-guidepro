...
import { ArrowLeft, ArrowRight, CheckCircle, Home, MapPin } from "lucide-react";
            ...
            >
              ...
              <div className="text-center mb-8">
                ...
                <p className="text-muted-foreground">
                  {score >= 7
                    ? "You're well prepared for your move!"
                    : score >= 4
                    ? "Let's get you prepared before you arrive"
                    : "I can help you plan a smooth relocation"}
                </p>
              </div>
              ...
              <Card className="mb-6">
                ...
                <ul className="space-y-3 text-sm text-muted-foreground">
                  <li className="flex items-start gap-2">
                    ...
                    Learning the area before you arrive will save you time and stress
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-amber-500 mt-2 flex-shrink-0" />
                    Getting pre-approved now will give you buying power when you land
                  </li>
                  <li className="flex items-start gap-2">
                    <span className="w-1.5 h-1.5 rounded-full bg-green-500 mt-2 flex-shrink-0" />
                    I can be your local expert and show you homes virtually before your visit
                  </li>
                </ul>
              </Card>
              ...
              <Card className="mb-6 border-primary/20 bg-primary/5">
                <p className="text-sm text-foreground leading-relaxed">
                  📍 Relocating can feel overwhelming. Let me be your{" "}
                  <span className="font-semibold text-primary">local guide</span> — I'll help you 
                  understand the neighborhoods, schools, and market before you even arrive.
                </p>
              </Card>
              ...
              <div className="mb-6">
                <AskSiriBox
                  header="💬 Questions About the Area?"
                  text="Moving somewhere new raises a lot of questions. Ask me about neighborhoods, schools, commute times, or anything else."
                  placeholder="What do you want to know about this area?"
